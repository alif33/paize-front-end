...
const SchoolInfo = () => {
  ...
  const { schoolName, schoolAddress, principleName, relation, phoneNumber } =
    schoolInfo;
  const onSubmit = (data) => {
    ...
    <Container>
      <From onSubmit={handleSubmit(onSubmit)}>
        ...
        <div className="inputsConatiner">
          ...
          <SchoolIcon />
          <div
            className={errors.schoolAddress ? "inputDiv active" : "inputDiv "}
          >
            <input
        ...
        <div className="inputsConatiner">
          ...
          <UserIcon />
          <div
            className={errors.principleName ? "inputDiv active" : "inputDiv "}
          >
            <input
